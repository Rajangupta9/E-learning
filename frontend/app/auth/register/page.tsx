...
import { Box, Button, TextField, Typography, Container, Alert, CircularProgress, InputAdornment, IconButton, Grid } from '@mui/material';
    ...
    return (
        ...
        <Box sx={{ minHeight: '100vh', display: 'flex', bgcolor: 'background.default' }}>
            ...
            <Box sx={{
                ...
                <Box sx={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', backgroundImage: 'url("https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1471&q=80")', backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.2 }} />

                <Box sx={{ position: 'relative', zIndex: 1, maxWidth: 480 }}>
                    <Typography variant="h3" fontWeight="800" gutterBottom>Join the Community</Typography>
                    ...
                    <Box component="form" onSubmit={handleSubmit}>
                        ...
                        <Box sx={{ textAlign: 'center' }}>
                            <Typography variant="body2" color="text.secondary">
                                ...
                                <Link href="/auth/login" style={{ textDecoration: 'none', color: '#4F46E5', fontWeight: 600 }}>
                                    Sign in
                                </Link>
                            </Typography>
                        </Box>
